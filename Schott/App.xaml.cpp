...
void App::OnFileActivated(Windows::ApplicationModel::Activation::FileActivatedEventArgs^ args)
{
	...
	Windows::Storage::IStorageItem^ fi = args->Files->First()->Current;

	auto getOp = Windows::Storage::StorageFile::GetFileFromPathAsync(fi->Path);
	concurrency::create_task(getOp).then([mainPage] (Windows::Storage::StorageFile^ fs) {
		mainPage->LoadFile(fs);
	});
}
